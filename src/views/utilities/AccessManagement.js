      ...
      <Grid item xl={12}>
        <SubCard title='Access Management'>
          ...
          <Grid container xl={10} spacing={2} sx={{ mt: 1 }} alignItems='center'>
            ...
            <Grid item xl={2}>
              <Button variant='outlined' color='secondary' onClick={handleAddField}>Add access</Button>
            </Grid>
          ...
          <Stack direction='row' sx={{ mt: 2, width: '100%' }} justifyContent='flex-end'>
            <Button variant='contained' size='small' color='secondary' sx={{ width: 'fit-content' }} onClick={handleSubmit}>Provide Access</Button>
          </Stack>
        </SubCard>
      </Grid>
    </Grid>
